...
CaseApp::CaseApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
	m_MainWndCaption = L"01_case_noperspective_interpolation";
	m_EnableDebug = false;
}
...
bool CaseApp::initEffect()
{
	...
	std::string vsCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/attribute_interpolation_feature/01_case_noperspective_interpolation/01_case_noperspective_interpolation_vs.cso");
	std::string vsFileName = FileSystem::getPath("shader_source/01_sole_feature/attribute_interpolation_feature/01_case_noperspective_interpolation/01_case_noperspective_interpolation_vs.hlsl");
	...
	std::string psCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/attribute_interpolation_feature/01_case_noperspective_interpolation/01_case_noperspective_interpolation_ps.cso");
	std::string psFileName = FileSystem::getPath("shader_source/01_sole_feature/attribute_interpolation_feature/01_case_noperspective_interpolation/01_case_noperspective_interpolation_ps.hlsl");
