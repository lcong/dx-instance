...
CaseApp::CaseApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
	m_MainWndCaption = L"01_case_gs_triangle_to_point";
	m_EnableDebug = false;
}
...
bool CaseApp::initEffect()
{
	...
	std::string vsCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/gs_feature/01_case_gs_triangle_to_point/01_case_gs_triangle_to_point_vs.cso");
	std::string vsFileName = FileSystem::getPath("shader_source/01_sole_feature/gs_feature/01_case_gs_triangle_to_point/01_case_gs_triangle_to_point_vs.hlsl");
	...
	std::string psCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/gs_feature/01_case_gs_triangle_to_point/01_case_gs_triangle_to_point_ps.cso");
	std::string psFileName = FileSystem::getPath("shader_source/01_sole_feature/gs_feature/01_case_gs_triangle_to_point/01_case_gs_triangle_to_point_ps.hlsl");
	...
	//创建几何着色器
	std::string gsFileName = FileSystem::getPath("shader_source/01_sole_feature/gs_feature/01_case_gs_triangle_to_point/01_case_gs_triangle_to_point_gs.hlsl");
	std::wostringstream gsFileWss;
