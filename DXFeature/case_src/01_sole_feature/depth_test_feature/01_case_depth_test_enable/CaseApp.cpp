...
bool CaseApp::initEffect()
{
	...
	std::string vsCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/depth_test_feature/01_case_depth_test_enable/01_case_depth_test_enable_vs.cso");
	std::string vsFileName = FileSystem::getPath("shader_source/01_sole_feature/depth_test_feature/01_case_depth_test_enable/01_case_depth_test_enable_vs.hlsl");
	...
	std::string psCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/depth_test_feature/01_case_depth_test_enable/01_case_depth_test_enable_ps.cso");
	std::string psFileName = FileSystem::getPath("shader_source/01_sole_feature/depth_test_feature/01_case_depth_test_enable/01_case_depth_test_enable_ps.hlsl");
...
bool CaseApp::initResource()
{
	...
	VertexPosColor vertexData[] =
	{
		...
		{vec4(0.0f,-0.5f,0.5f,1.0f),vec4(0.0f,0.0f,1.0f,1.0f)},
