...
CaseApp::CaseApp(HINSTANCE hInstance)
	: D3DApp(hInstance)
{
	m_MainWndCaption = L"01_case_blend_op_add_one";
	m_EnableDebug = false;
}
...
bool CaseApp::initEffect()
{
	...
	std::string vsCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/blend_feature/01_case_blend_op_add_one/01_case_blend_op_add_one_vs.cso");
	std::string vsFileName = FileSystem::getPath("shader_source/01_sole_feature/blend_feature/01_case_blend_op_add_one/01_case_blend_op_add_one_vs.hlsl");
	...
	std::string psCsoFileName = FileSystem::getPath("shader_source/01_sole_feature/blend_feature/01_case_blend_op_add_one/01_case_blend_op_add_one_ps.cso");
	std::string psFileName = FileSystem::getPath("shader_source/01_sole_feature/blend_feature/01_case_blend_op_add_one/01_case_blend_op_add_one_ps.hlsl");
...
bool CaseApp::initResource()
{
	...
	VertexPosColor vertexData1[] =
	{
		{vec4(0.0f,-0.5f,0.2f,1.0f),vec4(0.0f,1.0f,0.0f,1.0f)},
		{vec4(-0.5f,0.5f,0.2f,1.0f),vec4(0.0f,1.0f,0.0f,1.0f)},
		{vec4(0.5f,0.5f,0.2f,1.0f),vec4(0.0f,1.0f,0.0f,1.0f)},
	...
	m_pd3dImmediateContext->OMSetBlendState(m_pBlendState.Get(), nullptr, 0xffffffff);
	return true;
}
